...
import { Phone, ArrowRight, User, Mail, Lock, PhoneCall } from "lucide-react";
        ...
        >
          {slides.map((slide, index) => (
            <SwiperSlide key={index}>
              ...
              >
                {/* Overlay */}
                <div className="absolute inset-0 bg-gradient-to-r from-[#061220]/70 via-[#061220]/75 to-[#061220]/55" />
                    ...
                    <div className="max-w-full lg:max-w-[700px] text-center lg:text-left">
                      ...
                      <div className="flex flex-col sm:flex-row flex-wrap gap-4 mt-8 sm:mt-10 justify-center lg:justify-start">
                        <button
                          ...
                          className="bg-blue-800 hover:bg-blue-600 text-white px-6 sm:px-10 py-3 sm:py-4 rounded-md flex items-center justify-center gap-3 font-semibold"
                        >
                          Send Inquiry
                          <ArrowRight size={18} />
                        </button>
                        ...
                        <a
                          ...
                          className="border border-white text-white px-6 sm:px-10 py-3 sm:py-4 rounded-md flex items-center justify-center gap-3 font-semibold hover:bg-white/10"
                        >
                          <Phone size={18} />
                          Call Now
                        </a>
          ...
          {[
            ...
            >
              ...
              <div>
                ...
                <p className="text-gray-400 text-[9px] sm:text-sm">{item[1]}</p>
              </div>
            </div>
          ))}
        </div>
