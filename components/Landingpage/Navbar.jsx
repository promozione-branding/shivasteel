  ...
  return (
    <>
      <header className="fixed top-0 left-0 w-full z-[999] bg-white border-b border-slate-200">
        ...
        {/* MAIN NAV */}
        <div className="w-full mx-auto px-4 xl:px-6 md:px-20 h-24 flex items-center justify-between">
          {/* LOGO */}
          ...
          {/* NAV */}
          <nav className="hidden md:flex items-center gap-6 xl:gap-10 text-lg xl:text-xl text-black tracking-wider font-semibold">
            ...
            >
              ...
              {megaOpen && (
                <div
                  className="absolute top-full left-1/2 -translate-x-1/2 lg:right-1
                  w-[1100px] lg:w-[900px] bg-white border border-slate-200 shadow-xl z-50 flex"
                >
                  {/* LEFT CATEGORY (sticky feel) */}
                  {/* RIGHT PANEL */}

                  {/* RIGHT PRODUCTS */}
                  <div className="w-1/3 lg:w-[30%] xl:w-1/3 bg-blue-950 text-white">
                ...
                ${
                  ...
                  <div className="w-2/3 lg:w-[90%] p-8 bg-gradient-to-br from-white via-slate-50 to-slate-100">
                    {(() => {
                        ...
                        <>
                          ...
                          <div className="grid grid-cols-3 gap-5">
                            {active.products.slice(0, 3).map((p) => (
                              ...
                              >
                                <div className="h-47 xl:h-47 bg-slate-50 flex items-center justify-center overflow-hidden">
                                  <Image
                                    src={
                                      p.image?.[0]?.src || "/placeholder.png"
                                    }
                                    alt={p.name}
                                    width={190}
                                    height={170}
                                    className="object-cover xl:object-fill xl:w-46 xl:h-47  transition duration-500 group-hover:scale-110"
                                  />
                                </div>

                                <div className="p-5 lg:p-3">
                                  <h4 className="font-semibold text-slate-900 text-sm lg:text-sm xl:text-sm leading-6 line-clamp-2 group-hover:text-bluetransition">
                                    {p.name}
                                  </h4>
        ...
        {mobileOpen && (
          <div className="md:hidden border-t bg-white">
            <div className="p-6 flex flex-col text-slate-700">
              <Link href="/" className="py-3 border-b border-slate-200">
                Home
              </Link>

              <Link href="/about" className="py-3 border-b border-slate-200">
                About Us
              </Link>
              ...
              <Link href="/contact" className="py-3 border-b border-slate-200">
                Contact Us
              </Link>
