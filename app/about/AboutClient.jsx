          ...
          <div className="grid items-center gap-20 lg:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-2 text-lg leading-6 md:leading-9 text-black ">
                ...
                competitive prices. Our extensive product portfolio includes MS
                Pipes, MS Plates, MS Angles, MS Beams, MS Channels, MS GP
                Sheets, MS GI Sheets, Chequered Plates, Heavy Plates, Boiler
                Plates, Cable Trays, and Perforated Cable Trays. Every product
                we offer is sourced and supplied in accordance with industry
                standards to ensure exceptional strength, durability, and
                long-lasting performance.
              </p>

              {/* Feature Cards */}
              <div className="mt-5 md:mt-2 grid gap-5 grid-cols-2">
                {[
                  "Premium Quality Steel Products",
          ...
          <div className="grid items-center gap-20 lg:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-5 text-lg leading-6 md:leading-9 text-black ">
                ...
                commercial building, an industrial plant, or large-scale
                infrastructure development, we are committed to delivering
                products that meet your expectations in quality, reliability,
                and value.
              </p>
              ...
              <div className="relative">
                ...
                <div className="mt-3  text-lg leading-6 md:leading-9 text-black">
                  <p>
                    ...
                    solutions that meet the diverse requirements of
                    construction, engineering, manufacturing, and infrastructure
                    projects. We are dedicated to delivering products that
                    combine strength, durability, and value, ensuring every
                    customer receives the highest standard of quality. We strive
                    to build lasting relationships through exceptional customer
                    service, competitive pricing, and timely delivery. By
              ...
              <div className="relative">
                ...
                <div className="mt-4 space-y-6 text-lg leading-6 md:leading-9 text-black">
                  <p>
                    ...
                    fabrication industry. We aspire to be known for our
                    commitment to quality, innovation, and excellence while
                    consistently meeting the evolving needs of our customers and
                    industry. We envision contributing to the growth of the
                    construction, engineering, and industrial sectors by
                    supplying reliable steel products and delivering outstanding
                    service. Through continuous improvement, sustainable
                    business practices, and customer-focused solutions, we aim
                    to create long-term value for our clients and business
                    partners.
                  </p>
                </div>
              </div>
